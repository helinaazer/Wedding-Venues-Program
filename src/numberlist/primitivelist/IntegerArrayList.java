...
/**
 * This class extends the function in BigIntArrayList class.
 *
 * @author Chenyu Niu
 * @version 2/27/2020
 */
public class IntegerArrayList extends BigIntArrayList implements Serializable {
     ...
     */
    public int insert(long value) throws IndexRangeException {
     ...
     */
    public void deleteAll(long value) throws IndexRangeException {
     ...
     */
    public int locateLast(long value) throws IndexRangeException {
